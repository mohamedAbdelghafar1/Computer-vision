...
![Model Performance Metric 1](output/results/Screenshot%202025-09-26%20031402.png)
![Model Performance Metric 2](output/results/Screenshot%202025-09-26%20031435.png)

### Detection Insights
*(Below are evaluation captures illustrating precise bounding boxes and class confidence scores.)*

![Detection Output 1](output/results/Screenshot%202025-09-26%20031502.png)
![Detection Output 2](output/results/Screenshot%202025-09-26%20031551.png)
...
🎥 **[Watch Real-Time Drone Detection Output](output/results/Recording%202025-09-17%20172326%20(2).avi)**
